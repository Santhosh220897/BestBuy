...
public class WebUtilis extends JavaUtilis {
	...
	// Method for scroll & click clicking the element using javascript Executor
	...
	// Method for clicking the element using javascript Executor
	...
	// Method alert box
	public static void messageAlert(WebElement element) {
	...
	public static void datePick(List<WebElement> element, String date) {
		try {
			List<WebElement> dateTag = element;
	...
	public static void scroll() {
		...
		key.executeScript("window.scrollBy(0,800)");
	...
	// Method to get the Titlte of the Page
	...
	// Actions class method to move the pagedown
	...
	// Actions class method to move the pageup
	...
	// Actions class method to select & hold the element
	...
	// Method to handle the Weblements
	public static void dropdownList(List<WebElement> element, String value) {
	...
	// Mehtod to navigate to backward
